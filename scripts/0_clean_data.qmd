...
We are going to estimate arthropod's body mass as J. Pomeranz using taxon-­specific published length-­ weight regressions [@pomeranz2022]. Note that ISD relationships are sensitive to the under sampling of small body sizes. [@perkins2018] sampled benthic macroinvertebrates using comparable methods and found that body sizes smaller than 0.0026 mg were under sampled. Therefore, we will set the minimum body size to 0.0026 mg estimated dry weight before estimating ISD relationships to avoid the under sam- pling of small body sizes.
...
Extract unique combination of order - family
