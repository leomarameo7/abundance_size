...
-   Get used to the `brms` package syntax

-   Build your first simple model with only an intercept and one predictor (`location`).

-   Do prior predictive checks with this model
:::
