...
We are going to estimate arthropod's body mass (i.e. dry weight) using taxon-­specific published length-­weight coefficients. Remember that we are going to use the allometric relationship: $$W = a*L^b$$ {#eq-lw}where $W$ is the arthropod's dry weight in milligrams, $L$ is the arthropod's length in millimeters, $a$ and $b$ are constant coefficients.
