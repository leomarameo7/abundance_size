...
We have sampled the arthropod community in Swiss streams. We used three (3) different methods, catching different insect taxon. The three methods from now on we defined as: `emergent_trap`, `kick_net`, `suction`.
...
First let's check which families are there !
...
-   I will process the @pomeranz2022 dataset similarly, averaging $a$ and $b$ for families with multiple entries.
...
## Emergent trap: aquatic and terrestrial invertebrates community
