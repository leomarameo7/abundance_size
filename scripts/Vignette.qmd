...
Jeff Wesner and J. Pomeranz

-   Exclude emergent trap sampling

-   Use `location` as predictor : 4 levels . And then make inference.

-   Fix a body size cut off : waiting Jeff script
